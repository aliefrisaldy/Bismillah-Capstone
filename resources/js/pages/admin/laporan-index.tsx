...
const statusFilterOptions: { value: typeof STATUS_FILTER_ALL | LaporanItem['status']; label: string; dotClass: string }[] = [
    { value: STATUS_FILTER_ALL, label: 'Semua status', dotClass: 'bg-muted-foreground/35 ring-1 ring-border' },
    { value: 'menunggu', label: 'Menunggu', dotClass: 'bg-amber-500 shadow-[0_0_0_2px_rgba(245,158,11,0.25)]' },
    { value: 'diverifikasi', label: 'Diverifikasi', dotClass: 'bg-blue-500 shadow-[0_0_0_2px_rgba(59,130,246,0.25)]' },
    { value: 'diproses', label: 'Diproses', dotClass: 'bg-orange-500 shadow-[0_0_0_2px_rgba(249,115,22,0.25)]' },
    { value: 'selesai', label: 'Selesai', dotClass: 'bg-emerald-500 shadow-[0_0_0_2px_rgba(16,185,129,0.25)]' },
    { value: 'ditolak', label: 'Ditolak', dotClass: 'bg-red-500 shadow-[0_0_0_2px_rgba(239,68,68,0.25)]' },
];
                ...
                <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                        ...
                        {statCards.map((card, index) => (
                            <FadeIn key={card.label} delay={120 + index * 45}>
                                <div className="group relative flex flex-col gap-3 overflow-hidden rounded-2xl border border-border bg-card p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-sidebar-border/70">
                                    <div className={`flex h-10 w-10 items-center justify-center rounded-2xl ${card.color} ring-1 ring-border/40`}>
                                    ...
                                    <div className="pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-emerald-500/5 blur-2xl transition-opacity group-hover:opacity-90" />
                                </div>
                            </FadeIn>
                        ))}
                    </div>
                        ...
                        <div className="flex flex-col gap-3 md:flex-row md:items-end">
                            ...
                            <div className="w-full md:w-[240px]">
                                ...
                                <Select
                                    ...
                                    onValueChange={(v) =>
                                        setStatus(v === STATUS_FILTER_ALL ? '' : v)
                                    }
                                >
                    ...
                    <div className="flex flex-1 flex-col gap-4 rounded-xl border border-sidebar-border/70 bg-card p-4 dark:border-sidebar-border md:p-6">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xl font-bold text-foreground">Daftar Laporan</h2>
                                    ...
                                    <table className="w-full text-sm">
                                        ...
                                        <tbody className="divide-y divide-border">
                                            {laporan.data.map((item) => (
                                                <tr key={item.id_laporan} className="group transition-colors hover:bg-muted/40">
                                        ...
                                        {laporan.links.map((l, idx) => (
                                            <button
                                                ...
                                                className={[
                                                    ...
                                                    isFiltering || !l.url ? 'cursor-not-allowed opacity-50' : '',
                                                ].join(' ')}
